...
--drop database DemoDesignPattern
...
(
	...
	name nvarchar(100) not null default 'Taikhoan1',
	password nvarchar(100) not null default 'TK1234',
...
insert Account(email,name,password,role) values ('Manh@gmail.com',N'Mạnh','Manh123',3)
insert Account(email,name,password,role) values ('Minh@gmail.com',N'Minh','Minh123',1)
insert Account(email,name,password,role) values ('HuyA@gmail.com',N'Huy','Huy123',0)
